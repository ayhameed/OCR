...
%{
 ...
 Last Modified by GUIDE v2.5 27-Apr-2017 07:26:43
...
choice = questdlg('Would you like Exit?', ...
...
% --------------------------------------------------------------------
function alphabet_Callback(hObject, eventdata, handles)
% hObject    handle to alphabet (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
cd('C:\Users\Adulhameed\Documents\MATLAB\chr\chr\newcr');
interface;
